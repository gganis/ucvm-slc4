...
LDFLAGS     = $(JMUID) $(UNDEF) -L$(ALEPH)/lib -L$(ALEPH)/phy -L$(ALEPH)/jul  -L$(ALEPH)/gen -L/usr/lib/gcc/x86_64-redhat-linux/4.4.4/32/
##LDFLAGS    = $(UNDEF) -L$(ALEPH)/lib -L$(ALEPH)/phy -L$(ALEPH)/jul  -L$(ALEPH)/gen

ALIB       += -lbos77
CERNLIBS = `/cern/pro/bin/cernlib $(CLIB) mathlib packlib_noshift` -lgfortran
